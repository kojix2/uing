module AirHockey3DConfig
  ...
  # projective transform used by AirHockey3DGame#project.
  FAR_SCALE  = 0.56
  NEAR_SCALE = 1.28
  ...
  # Audio is enabled by default. Set AIR_HOCKEY3D_AUDIO=0 when running in CI or
  # on machines without an audio device.
  AUDIO_ENABLED = ENV["AIR_HOCKEY3D_AUDIO"]? != "0"

  DEBUG = ENV["AIR_HOCKEY3D_DEBUG"]? == "1"
end
