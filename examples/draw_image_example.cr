...
window = UIng::Window.new("Draw Image Example", 400, 300, margined: true)
...
area_handler = UIng::Area::Handler.new do |header|
  draw do |area, params|
    ...
    begin
      ...
      ctx.draw_image(image, 150, 10, 150, 100)
      ctx.draw_image(image, 10, 150, 50, 50)
      ctx.draw_image(image, 150, 150, 200, 50)
    rescue ex
