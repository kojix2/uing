...
module UIng
  ...
  lib LibUI
    ...
    fun toolbar_item_enabled = uiToolbarItemEnabled(item : Pointer(ToolbarItem)) : Bool
    ...
    fun toolbar_item_checked = uiToolbarItemChecked(item : Pointer(ToolbarItem)) : Bool
    fun toolbar_item_set_checked = uiToolbarItemSetChecked(item : Pointer(ToolbarItem), checked : Bool)
    alias Button = Void
