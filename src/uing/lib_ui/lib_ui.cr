...
module UIng
  ...
  lib LibUI
    ...
    fun window_fullscreen = uiWindowFullscreen(w : Pointer(Window)) : LibC::Int
    fun window_set_fullscreen = uiWindowSetFullscreen(w : Pointer(Window), fullscreen : LibC::Int)
    ...
    fun window_focused = uiWindowFocused(w : Pointer(Window)) : LibC::Int
    fun window_borderless = uiWindowBorderless(w : Pointer(Window)) : LibC::Int
    fun window_set_borderless = uiWindowSetBorderless(w : Pointer(Window), borderless : LibC::Int)
    fun window_set_child = uiWindowSetChild(w : Pointer(Window), child : Pointer(Control))
    fun window_margined = uiWindowMargined(w : Pointer(Window)) : LibC::Int
    fun window_set_margined = uiWindowSetMargined(w : Pointer(Window), margined : LibC::Int)
    fun window_resizeable = uiWindowResizeable(w : Pointer(Window)) : LibC::Int
    fun window_set_resizeable = uiWindowSetResizeable(w : Pointer(Window), resizeable : LibC::Int)
    fun new_window = uiNewWindow(title : Pointer(LibC::Char), width : LibC::Int, height : LibC::Int, has_menubar : LibC::Int) : Pointer(Window)
    alias Toolbar = Void
    ...
    fun toolbar_item_tooltip = uiToolbarItemTooltip(item : Pointer(ToolbarItem)) : Pointer(LibC::Char)
    fun toolbar_item_set_tooltip = uiToolbarItemSetTooltip(item : Pointer(ToolbarItem), tooltip : Pointer(LibC::Char))
    fun toolbar_item_enabled = uiToolbarItemEnabled(item : Pointer(ToolbarItem)) : LibC::Int
    fun toolbar_item_enable = uiToolbarItemEnable(item : Pointer(ToolbarItem))
    fun toolbar_item_disable = uiToolbarItemDisable(item : Pointer(ToolbarItem))
    fun toolbar_item_on_clicked = uiToolbarItemOnClicked(item : Pointer(ToolbarItem), f : (Pointer(ToolbarItem), Pointer(Void) -> Void), data : Pointer(Void))
    fun toolbar_item_checked = uiToolbarItemChecked(item : Pointer(ToolbarItem)) : LibC::Int
    fun toolbar_item_set_checked = uiToolbarItemSetChecked(item : Pointer(ToolbarItem), checked : LibC::Int)
    alias Button = Void
    ...
    fun box_padded = uiBoxPadded(b : Pointer(Box)) : LibC::Int
    fun box_set_padded = uiBoxSetPadded(b : Pointer(Box), padded : LibC::Int)
    ...
    fun checkbox_checked = uiCheckboxChecked(c : Pointer(Checkbox)) : LibC::Int
    fun checkbox_set_checked = uiCheckboxSetChecked(c : Pointer(Checkbox), checked : LibC::Int)
    ...
    fun entry_read_only = uiEntryReadOnly(e : Pointer(Entry)) : LibC::Int
    fun entry_set_read_only = uiEntrySetReadOnly(e : Pointer(Entry), readonly : LibC::Int)
    ...
    fun tab_margined = uiTabMargined(t : Pointer(Tab), index : LibC::Int) : LibC::Int
    fun tab_set_margined = uiTabSetMargined(t : Pointer(Tab), index : LibC::Int, margined : LibC::Int)
    ...
    fun group_margined = uiGroupMargined(g : Pointer(Group)) : LibC::Int
    fun group_set_margined = uiGroupSetMargined(g : Pointer(Group), margined : LibC::Int)
    ...
    fun slider_has_tool_tip = uiSliderHasToolTip(s : Pointer(Slider)) : LibC::Int
    fun slider_set_has_tool_tip = uiSliderSetHasToolTip(s : Pointer(Slider), has_tool_tip : LibC::Int)
    ...
    fun menu_item_checked = uiMenuItemChecked(m : Pointer(MenuItem)) : LibC::Int
    fun menu_item_set_checked = uiMenuItemSetChecked(m : Pointer(MenuItem), checked : LibC::Int)
    alias Menu = Void
    ...
    fun draw_path_new_figure_with_arc = uiDrawPathNewFigureWithArc(p : Pointer(DrawPath), x_center : LibC::Double, y_center : LibC::Double, radius : LibC::Double, start_angle : LibC::Double, sweep : LibC::Double, negative : LibC::Int)
    fun draw_path_line_to = uiDrawPathLineTo(p : Pointer(DrawPath), x : LibC::Double, y : LibC::Double)
    fun draw_path_arc_to = uiDrawPathArcTo(p : Pointer(DrawPath), x_center : LibC::Double, y_center : LibC::Double, radius : LibC::Double, start_angle : LibC::Double, sweep : LibC::Double, negative : LibC::Int)
    ...
    fun draw_path_ended = uiDrawPathEnded(p : Pointer(DrawPath)) : LibC::Int
    ...
    fun draw_matrix_invertible = uiDrawMatrixInvertible(m : Pointer(DrawMatrix)) : LibC::Int
    fun draw_matrix_invert = uiDrawMatrixInvert(m : Pointer(DrawMatrix)) : LibC::Int
    ...
    fun form_padded = uiFormPadded(f : Pointer(Form)) : LibC::Int
    ...
    fun grid_padded = uiGridPadded(g : Pointer(Grid)) : LibC::Int
    fun grid_set_padded = uiGridSetPadded(g : Pointer(Grid), padded : LibC::Int)
    ...
    fun table_header_visible = uiTableHeaderVisible(t : Pointer(Table)) : LibC::Int
    fun table_header_set_visible = uiTableHeaderSetVisible(t : Pointer(Table), visible : LibC::Int)
