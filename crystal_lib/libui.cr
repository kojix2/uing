...
lib LibUI
  ...
  fun alloc_control = uiAllocControl(n : Void, o_ssig : Void, typesig : Void, typenamestr : Pointer(LibC::Char)) : Pointer(Void)
  ...
  fun area_begin_user_window_resize = uiAreaBeginUserWindowResize(a : Pointer(Void), edge : Void)
  ...
  fun draw_new_path = uiDrawNewPath(fill_mode : Void) : Pointer(Void)
  ...
  fun new_weight_attribute = uiNewWeightAttribute(weight : Void) : Pointer(Void)
  fun attribute_weight = uiAttributeWeight(a : Pointer(Void))
  fun new_italic_attribute = uiNewItalicAttribute(italic : Void) : Pointer(Void)
  fun attribute_italic = uiAttributeItalic(a : Pointer(Void))
  fun new_stretch_attribute = uiNewStretchAttribute(stretch : Void) : Pointer(Void)
  ...
  fun new_underline_attribute = uiNewUnderlineAttribute(u : Void) : Pointer(Void)
  fun attribute_underline = uiAttributeUnderline(a : Pointer(Void))
  fun new_underline_color_attribute = uiNewUnderlineColorAttribute(u : Void, r : LibC::Double, g : LibC::Double, b : LibC::Double, a : LibC::Double) : Pointer(Void)
  ...
  fun open_type_features_add = uiOpenTypeFeaturesAdd(otf : Pointer(Void), a : LibC::Char, b : LibC::Char, c : LibC::Char, d : LibC::Char, value : Void)
  ...
  fun open_type_features_for_each = uiOpenTypeFeaturesForEach(otf : Pointer(Void), f : Void, data : Pointer(Void))
  ...
  fun attributed_string_insert_at_unattributed = uiAttributedStringInsertAtUnattributed(s : Pointer(Void), str : Pointer(LibC::Char), at : Void)
  fun attributed_string_delete = uiAttributedStringDelete(s : Pointer(Void), start : Void, _end : Void)
  fun attributed_string_set_attribute = uiAttributedStringSetAttribute(s : Pointer(Void), a : Pointer(Void), start : Void, _end : Void)
  fun attributed_string_for_each_attribute = uiAttributedStringForEachAttribute(s : Pointer(Void), f : Void, data : Pointer(Void))
  fun attributed_string_num_graphemes = uiAttributedStringNumGraphemes(s : Pointer(Void))
  fun attributed_string_byte_index_to_grapheme = uiAttributedStringByteIndexToGrapheme(s : Pointer(Void), pos : Void)
  fun attributed_string_grapheme_to_byte_index = uiAttributedStringGraphemeToByteIndex(s : Pointer(Void), pos : Void)
  ...
  alias Grid = Void
  fun grid_append = uiGridAppend(g : Pointer(Void), c : Pointer(Void), left : LibC::Int, top : LibC::Int, xspan : LibC::Int, yspan : LibC::Int, hexpand : LibC::Int, halign : Void, vexpand : LibC::Int, valign : Void)
  fun grid_insert_at = uiGridInsertAt(g : Pointer(Void), c : Pointer(Void), existing : Pointer(Void), at : Void, xspan : LibC::Int, yspan : LibC::Int, hexpand : LibC::Int, halign : Void, vexpand : LibC::Int, valign : Void)
  ...
  fun table_header_set_sort_indicator = uiTableHeaderSetSortIndicator(t : Pointer(Void), column : LibC::Int, indicator : Void)
  ...
  fun table_set_selection_mode = uiTableSetSelectionMode(t : Pointer(Void), mode : Void)
